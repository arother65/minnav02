...
// import { blue, brown, green, grey, red, orange, yellow } from '@mui/material/colors'
...
export default function TestComponents(props) {
  ...
  // ! 
  //   const container01 = rotorBaseModel.children[0].children[0].children[0].children[0].children[0]
...
export function ControlRoomMonitor(props) {
  ...
  const { scene } = useGLTF('/models/control_room_monitor.glb')  // exports scene, nodes...
  ...
  return (
    <>
      {/* <primitive object={controlMonitorModel} {...props} /> */}

      {/** einzelne Objekte der controlMonitorModel anzeigen: */}
...
export function Trees(props) {
  ...
  return (
    <>
      ...
      {/** einzelne Objekte der treeModel anzeigen: */}
      {/* <mesh geometry={geometry01} material={material01} {...props} castShadow receiveShadow /> */}
...
export function M977(props) {
  ...
  // m977Model.children[0].children[0].children[0].children  // enhält
  ...
  return (
    <>
      ...
      {/** einzelne Objekte der m977Model anzeigen: */}
      {/* <mesh geometry={geometry01} material={material01} {...props} castShadow receiveShadow /> */}
...
export function Ural4320(props) {
  ...
  children[0].material.metalness = 0.35
  children[0].material.roughness = 0.55
  ...
  // const camoTexture = useMemo(() => createNatoCamoTexture([red[100], red[400], red[900]]), []) 
  ...
  // useEffect(() => {
  // truck to the left 
  // const children = ural4320Model.children[0].children[0].children[0].children[0].children  // 17 objects
  ...
  children.forEach((child, index) => {
    ...
    try {
      ...
      d3obj.material.color = { isColor: true, r: 2, g: 2, b: 2 }  // all other truck parts
