        ...
        <Card >
          <CardContent>
            ...
            <Box orientation='col'
              ...
              sx={{ minHeight: '150px', minWidth: '150px', border: '1px solid green' }}
            >
              {/* von oben die Szene betrachten: camera={{ position: [0, 5, 0] }} */}
              <Canvas camera={{ position: [0, 2, 10], fov: 95 }}
                style={{
                  width: "25vw",
                  height: "25vh",
                  display: "block"
              ...
              >
                ...
                <Physics gravity={[0, 0, 25]}>
                  <PhysicsBall position={[1, 1, -1.5]} color={'lightblue'} />
                  <PhysicsBall position={[1, 1, -1]} color={'green'} />
                  <PhysicsBall position={[1, 1, -0.5]} color={'darkgreen'} />
                </Physics>
              </Canvas>
            </Box>
          </CardContent>
    ...
    <AppBar sx={{ backgroundColor: 'rgba(40, 45, 60, 0.85)', position: 'fixed' }} >
      <Toolbar>
        ...
        >
          ...
          {/* Modal used for animation, set to true by generated useState()-function */}
          <AnimatedModal />
